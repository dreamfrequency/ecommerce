...
//        echo "<li><a href='index.php?cat=$cat_id'>$cat_title</a><li>";
		echo "<a href='index.php?cat=$cat_id' class='list-group-item list-group-item-action'>$cat_title </a>";
...
//        echo "<li><a href='index.php?brand=$brand_id'>$brand_title</a><li>";
		echo "<a href='index.php?brand=$brand_id' class='list-group-item list-group-item-action'>$brand_title </a>";
